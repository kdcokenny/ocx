...
# Add a private GitHub repo as a registry
ocx registry add github:my-org/my-registry --name myregistry

# Pin to a specific branch or tag
ocx registry add github:my-org/my-registry@v2.0 --name myregistry
...
- [Private GitHub Registry](/guides/github-registry) — Host a registry on a private GitHub repo.
